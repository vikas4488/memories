...
lan={
    ...
    btn_rej:'बटन रद्द ',
    ip_clr:'इनपुट ',
    login_border:'लॉगिन सीमा का रंग',
    reg_border:'पंजीकरण सीमा का रंग',
    login_label_clr:'लॉगिन लेबल का रंग',
    reg_label_clr:'पंजीकरण लेबल रंग',
    ...
    label_clr:'label ',
    popup_clr:'popup ',
    btn_cnf:'Button confirm',
    btn_pro:'Button Progress',
    btn_upd:'Button Update',
    btn_rej:'Button cancle',
    ip_clr:'Input',
    login_border:'Login border color',
    reg_border:'Registration border color',
    login_label_clr:'Login label color',
    reg_label_clr:'Registration label color',
